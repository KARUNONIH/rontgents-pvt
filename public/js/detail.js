...
const prevBtn =
  document.getElementById("prevNextBtn").firstElementChild.children[0];
const nextBtn =
  document.getElementById("prevNextBtn").firstElementChild.children[1];
...
const listInfo = [
  {
    judul: "Bantalan",
    content:
      "Digunakan untuk  mengatur agar hewan tidak banyak gerak selama proses rontgen",
  },
  {
    judul: "Papan pelindung",
    content:
      "Digunakan sebagai penghalang bagi dokter hewan dari radiasi sinar x-ray ketika akan melakukan proses penembakan sinar x-ray ",
  },
  {
    judul: "Penyimpan kaset film",
    content:
      "Berfungsi sebagai tempat untuk menyimpan gambar hasil dari rongent.",
  },
  {
    judul: "Lubang kunci",
  ...
  },
  {
    ...
    content:
      "Mengeluarkan gelombang suara ketika proses rontgen sedang berlangsung",
  },
  {
    judul: "Penggaris",
  ...
  },
  {
    judul: "Switch",
    content:
      "Sebuah tombol on/off alat pengisian daya untuk mendapatkan energi cadangan apabila listrik padam.",
  },
  {
    judul: "Knob (depan)",
  ...
  },
  {
    judul: "Generator",
    content:
      "Digunakan untuk menghasilkan daya listrik yang diperlukan untuk mengoperasikan alat rontgen",
  },
  {
    judul: "Meja Rontgen",
  ...
  },
  {
    judul: "Komputer",
    content:
      "Berfungsi sebagai alat penyimpanan dan pengelolaan hasil gambar dari proses rontgen yang telah dilakukan. Jika ingin mencetak hasilnya, dapat menggunakan printer",
  },
  {
    judul: "Printer",
  ...
  },
  {
    judul: "mAs control",
    content:
      "Nilainya disesuaikan dengan bagian tubuh yang akan discan. Semakin banyak organ pada bagian tubuh yang di scan, semakin besar nilai mAs yang diperlukan",
  },
  {
  ...
  },
  {
    judul: "Panel Control",
    content:
      "panel yang berisikan tombol-tombol untuk mengatur output yang dihasilkan oleh alat rontgen",
  },
  {
    judul: "S-M-L (ukuran hewan)",
    content:
      "Untuk menentukan ukuran hewan yang di-scan (disarankan untuk hewan tidak terlalu besar seperti anjing, kucing, dll)",
  },
  {
    judul: "Lampu",
    content: "Untuk menyalakan lampu pada alat rontgen",
  },
  {
    judul: "Density",
...
function onClick(event) {
  ...
  if (intersects.length > 0) {
    ...
    console.log(
      "Posisi objek yang diklik (x, y, z):",
      targetPosition.x,
      targetPosition.y,
      targetPosition.z
    );
    ...
    for (const boundary of boundaries) {
      ...
      if (
        (targetPosition.x >= boundary.minX &&
          targetPosition.x <= boundary.maxX &&
          targetPosition.y >= boundary.minY &&
          targetPosition.y <= boundary.maxY &&
          targetPosition.z >= boundary.minZ &&
          targetPosition.z <= boundary.maxZ) ||
        (!initialSet && panelIndex >= 16 && panelIndex < 22)
        ...
        if (infoModel.judul == "Panel Control") {
        ...
        if (panelIndex > 16 && panelIndex < 22) {
          infoModel = listInfo[panelIndex];
          scene.remove(boxes[prevIndex - 16]);
          scene.add(boxes[panelIndex - 16]);
        }
    ...
    if (cameraMoved) {
      ...
      controls.update();
      cameraMoved = false;
      scene.remove(boxes[panelIndex - 16]);
      scene.remove(boxes[prevIndex - 16]);
